(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('ngx-odinvt-emoji-mart', ['exports', '@angular/core', '@angular/common', '@angular/forms'], factory) :
	(factory((global['ngx-odinvt-emoji-mart'] = {}),global.ng.core,global.ng.common,global.ng.forms));
...
var EmojiService = /** @class */ (function () {
    ...
    EmojiService.prototype.uncompress = function (list) {
        ...
        this.emojis = list.map(function (emoji) {
            ...
            if (data.obsoletes) {
                ...
                if (f) {
                    if (f.keywords) {
                        data.keywords = __spread(data.keywords, f.keywords, [f.short_name]);
                    }
                    else {
                        data.keywords = __spread(data.keywords, [f.short_name]);
                    }
                }
            }
            _this.names[data.unified] = data;
            try {
                for (var _a = __values(data.short_names), _b = _a.next(); !_b.done; _b = _a.next()) {
                    var n = _b.value;
                    _this.names[n] = data;
                }
            }
    ...
    EmojiService.prototype.getData = function (emoji, skin, set) {
        ...
        if (emojiData.skin_variations && emojiData.skin_variations.length && skin && skin > 1 && set) {
            ...
            var variationData = emojiData.skin_variations.find(function (n) { return n.unified.indexOf(skinKey_1) !== -1; });
        ...
        try {
            for (var allCategories_1 = __values(allCategories), allCategories_1_1 = allCategories_1.next(); !allCategories_1_1.done; allCategories_1_1 = allCategories_1.next()) {
                ...
                if (this.emojisToShowFilter) {
                    var newEmojis = [];
                    var emojis_1 = category.emojis;
                    for (var emojiIndex = 0; emojiIndex < ((emojis_1)).length; emojiIndex++) {
                        var emoji = ((emojis_1))[emojiIndex];
...
var EmojiComponent = /** @class */ (function () {
    ...
    EmojiComponent.prototype.getPosition = function () {
        var _a = __read(this.getData().sheet, 2), sheet_x = _a[0], sheet_y = _a[1];
...
EmojiComponent.decorators = [
    { type: core.Component, args: [{
                selector: 'ngx-odinvt-emoji-mart/ngx-emoji',
...
PickerModule.decorators = [
    { type: core.NgModule, args: [{
                imports: [common.CommonModule, forms.FormsModule, EmojiModule],
                exports: components,
...
exports.ɵc = EmojiComponent;
exports.ɵb = EmojiModule;
exports.ɵa = EmojiService;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-odinvt-emoji-mart.umd.js.map
